...
class Uranus(Form):
	...
	def InitializeComponent(self):
		...
		self._label7.Text = "8.69 x 10^25 kg"
		# 
		# label6
		# 
		...
		self.Name = "Uranus"
		self.Text = "Uranus"
		self.FormClosing += self.UranusFormClosing
	...
	def UranusFormClosing(self, sender, e):
		self.parent.Show()