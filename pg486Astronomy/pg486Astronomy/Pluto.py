...
class Pluto(Form):
	...
	def InitializeComponent(self):
		...
		self._label7.Text = "1.2 x 10^22 kg"
		# 
		# label6
		# 
		...
		self.Name = "Pluto"
		self.Text = "Pluto"
		self.FormClosing += self.PlutoFormClosing
		self.Load += self.PlutoLoad
		self.ResumeLayout(False)


	def PlutoLoad(self, sender, e):
		pass
	...
	def PlutoFormClosing(self, sender, e):
		self.parent.Show()