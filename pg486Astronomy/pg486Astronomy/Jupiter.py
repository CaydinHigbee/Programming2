...
class Jupiter(Form):
	...
	def InitializeComponent(self):
		...
		self._label7.Text = "0.6424 x 10^27 kg"
		# 
		# label6
		# 
		...
		self._label4.Location = System.Drawing.Point(5, 158)
		self._label4.Name = "label4"
		self._label4.Size = System.Drawing.Size(103, 23)
		self._label4.TabIndex = 21
		self._label4.Text = "Temp at cloud tops:"
		...
		self.Name = "Jupiter"
		self.Text = "Jupiter"
		self.FormClosing += self.JupiterFormClosing
	...
	def JupiterFormClosing(self, sender, e):
		self.parent.Show()