...
class Earth(Form):
	...
	def InitializeComponent(self):
		...
		self._label8.Text = "-50 C to 50 C"
		# 
		# label7
		# 
		...
		self._label7.Text = "5.967 x 10^24 kg"
		# 
		# label6
		# 
		...
		self.Name = "Earth"
		self.Text = "Earth"
		self.FormClosing += self.EarthFormClosing
	...
	def EarthFormClosing(self, sender, e):
		self.parent.Show()