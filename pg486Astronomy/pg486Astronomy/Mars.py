...
class Mars(Form):
	...
	def InitializeComponent(self):
		...
		self._label8.Text = "-140 C to 20 C"
		# 
		# label7
		# 
		...
		self._label7.Text = "0.6424 x 10^24 kg"
		# 
		# label6
		# 
		...
		self.Name = "Mars"
		self.Text = "Mars"
		self.FormClosing += self.MarsFormClosing
	...
	def MarsFormClosing(self, sender, e):
		self.parent.Show()