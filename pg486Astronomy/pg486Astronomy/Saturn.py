...
class Saturn(Form):
	...
	def InitializeComponent(self):
		...
		self._label7.Text = "5.69 x 10^26 kg"
		# 
		# label6
		# 
		...
		self.Name = "Saturn"
		self.Text = "Saturn"
		self.FormClosing += self.SaturnFormClosing
	...
	def SaturnFormClosing(self, sender, e):
		self.parent.Show()